        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
              ...
              <div className="space-y-4">
                {contactInfo.map((info, index) => (
                  <motion.a
                    ...
                    viewport={{ once: true }}
                    className="flex items-center p-4 rounded-lg bg-card/30 backdrop-blur-sm border border-border/50 hover:bg-accent/50 transition-colors group"
                  >
                    <div className="p-3 rounded-full bg-primary/10 group-hover:bg-primary/20 transition-colors mr-4">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-6 rounded-lg bg-gradient-to-r from-primary/10 to-accent/10 border border-border/50"
            >
              <h4 className="mb-2">Let's Create Something Amazing</h4>
